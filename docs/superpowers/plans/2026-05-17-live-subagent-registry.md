...
```bash
rg "list_agents|listAgentsTool|list-agents-tool|SubagentRecord|subagentRecordSchema|snapshot\.subagents|toSnapshot\(\)\.subagents|subagents:" apps/backend/src -n
```
